...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    try {
        ...
        // ✅ un seul commit, à la toute fin, une fois que tout a réussi
        $pdo->commit();

    } catch (Exception $e) {
        // ⚠️ on ne rollback que s'il existe encore une transaction active
        // (évite un 2e crash si l'exception vient d'un commit déjà passé)
