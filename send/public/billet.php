...
/* =========================================
   🔒 Accès par token opaque (non devinable),
   plus par id incrémental (énumérable).
   Le token est généré une seule fois à la
   création du billet dans finaliser_billet.php
   et stocké dans billets.token_acces.
========================================= */
...
$id = $billet['id']; // gardé en interne (nom de fichier QR, etc.) mais jamais exposé dans l'URL
...
$qrFile = "qrcodes/billet_" . $billet['id'] . "_" . md5($billet['code_qr']) . ".png";
...
<a
href="generate_pdf.php?token=<?= urlencode($token) ?>"
target="_blank"
class="btn-pdf">
