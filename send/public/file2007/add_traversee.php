...
<select class="form-select mb-4" name="bateau" required>

<option value="">Choisir bateau</option>

<option value="A.S.D">A.S.D</option>

<option value="AGUENE">AGUENE</option>

<option value="DIAMBOGNE">DIAMBOGNE</option>

</select>

<div class="alert alert-secondary">
ℹ️ Les places <strong>302.12A-H</strong>, <strong>302.15A-H</strong> (Cabine 8) et une partie du <strong>Pullman</strong> (A2.6-15, B2.2-15, C2.2-15, D2.2-3) sont automatiquement réservées à chaque création de voyage, inutile de les cocher.
</div>
